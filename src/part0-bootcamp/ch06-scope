Зрозумів! Ви хочете, щоб я переписав матеріал про область видимості, дотримуючись такої ж структури та стилю оформлення. Ось переписаний варіант:

---

# Область видимості змінних у Rust
